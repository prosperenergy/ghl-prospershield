...
Generated: 2026-06-15T00:56:51.938Z
...
- Credential/connector systems mapped: 16; credential refs listed: 248
...
| Redis | Prosper Redis bus + agent streams | validated | PROSPER_REDIS_BUS_ENABLED, REDIS_API_KEY, REDIS_CLOUD_API_KEY, REDIS_CLOUD_API_KEY_OP, REDIS_DUAL_WRITE_ENABLED, REDIS_HOST, REDIS_PASSWORD_OP, REDIS_PORT, REDIS_STREAMS_PRIMARY, REDIS_STREAM_MAXLEN, REDIS_TLS, REDIS_URL, REDIS_USER | redis-prosper returned PONG. |
| 1Password / OP | 1Password CLI/service-token refs | needs-login | ONEPASSWORD_CONNECT_TOKEN, OP_CONNECT_TOKEN, OP_SERVICE_ACCOUNT_TOKEN | 1Password CLI is installed but op whoami reports no account in this shell. OP service/connect token refs exist and remain redacted. |
...
| SignNow | SignNow e-signature API | present-not-tested | SIGNNOW_ACCOUNT_EMAIL, SIGNNOW_ACCOUNT_PASSWORD, SIGNNOW_API_BASE, SIGNNOW_BASIC_AUTH, SIGNNOW_CLIENT_ID, SIGNNOW_CLIENT_SECRET, SIGNNOW_MAIN_FOLDER_ID, SIGNNOW_TEAM_FOLDER_ID, SIGNNOW_WEBHOOK_SECRET | SignNow credential refs are present, including login and OAuth-style refs. Values are redacted and no signing action was performed. |
